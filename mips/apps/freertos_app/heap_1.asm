...
$L2:
	...
	lw	$2,%gp_rel(pucAlignedHeap.2389)($28)
	nop
	bne	$2,$0,$L3
	lui	$2,%hi(ucHeap+4)
	...
	and	$2,$2,$3
	sw	$2,%gp_rel(pucAlignedHeap.2389)($28)
$L3:
	...
	lw	$17,%gp_rel(pucAlignedHeap.2389)($28)
...
xPortGetFreeHeapSize:
	...
	.local	pucAlignedHeap.2389
	.comm	pucAlignedHeap.2389,4,4
	.local	xNextFreeByte
