...
#define TM_THREADX_THREAD_STACK_SIZE    512
...
#define TM_THREADX_MEMORY_POOL_SIZE     128
...
unsigned char   tm_pool_memory_area[TM_THREADX_MAX_MEMORY_POOLS*TM_THREADX_MEMORY_POOL_SIZE*2];
